...
class BackgroundIndexer:
    ...
    def __init__(self, vector_db: VectorDatabase):
        ...
        self.splitter = SemanticSplitter(
            chunk_size=config.memory.chunk_size, overlap=config.memory.chunk_overlap
        )
    ...
    async def scan_and_index(self):
        ...
        ALLOWED_EXT = {".py", ".md", ".txt", ".js", ".ts", ".yaml", ".yml", ".sol"}

        logger.info(f"Starting optimized background indexing of {self.workspace}")
            ...
            for root, dirs, files in os.walk(self.workspace):
                ...
                for file in files:
                    ...
                    if ext in ALLOWED_EXT:
                        ...
                        await asyncio.sleep(0.05)  # Gentler sleep
        finally:
            self.is_running = False
