...
class PreflightCommander:
        ...
        try:
            ...
            if isinstance(result, dict) and not result.get("error"):
                ...
                if has_trade:
                    ...
                    logger.success("✅ [BYBIT] API ключ имеет торговые права.")
                else:
                    self.report.bybit_permissions_ok = False
                    logger.critical(
                        "❌ [BYBIT] API ключ НЕ имеет прав ContractTrade! "
                        "Исполнение ордеров невозможно."
                    )
            else:
    ...
    def format_boot_report_telegram(self) -> str:
        ...
        return (
            f"🚀 <b>TEKTON_ALPHA: PRE-FLIGHT PASSED</b>\n"
            f"━━━━━━━━━━━━━━━━━━━\n"
            f"🛡️ <b>Режим:</b> {r.mode}\n"
            f"🔑 <b>API Ключи:</b> {keys_status}\n"
            f"🔐 <b>Права торговли:</b> {perms}\n"
